    ...
    (<DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-[#539592] text-white p-0 hover:opacity-90"
        ),
        ...
        head_row: "flex",
        head_cell:
          "text-[#273029] w-9 font-normal text-[0.8rem]",
        ...
        day_selected:
          "bg-[#f2994a] text-white hover:bg-[#da863c] hover:text-white focus:bg-slate-900 focus:text-slate-50 dark:bg-slate-50 dark:text-slate-900 dark:hover:bg-slate-50 dark:hover:text-slate-900 dark:focus:bg-slate-50 dark:focus:text-slate-900",

...
const StyleGuide = () => {
  ...
  return (
    ...
    <div className="flex flex-col gap-y-4 p-24">
        ...
        <h3>3</h3>
        <p>
            Lorem ipsum dolor, sit amet consectetur adipisicing elit. Minima adipisci fuga odit modi, iste porro labore aspernatur ipsam, consequatur nihil temporibus voluptatem corrupti illum molestias sint libero veritatis eveniet possimus!
        </p>
    </div>

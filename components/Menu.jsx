    ...
    <section className="relative py-12 xl:py-24 bg-menu" id="menu">
      <div className="container mx-auto">
        ...
        >
          ...
          <Link
            href="/"
            className="text-green justify-center flex xl:justify-end items-center mb-16"
          >
            View all
        ...
        <motion.div
          ...
          whileInView={"show"}
          viewport={{ once: false, amount: 0.2 }}
          className="grid grid-cols-1 gap-[38px] md:grid-cols-3 md:gap-[15px] xl:grid-cols-4"
        >
          {menu.map((item, index) => {
            return (
              <div
                key={index}
                className="max-w-[278px] bg-white shadow-primary mx-auto xl:mx-0 group"
              >
                {/* image */}
